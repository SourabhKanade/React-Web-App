    ...
    <>
      <header>
        <section className="container main-hero-container">
          <div className="row">
            <div className="col-12 col-lg-6 header-left-side d-flex justify-content-center flex-column align-items-start prog1-img">
              ...
              <div className="social-links me-auto mb-4 mb-lg-0 Icon d-flex align-items-center justify-content-center">
                <a
                  className="root-icon"
                  href="github"
                  // target="_blank"
        ...
        <div className="d-flex align-items-center justify-content-center">
          <span className="button-icon jss305">
            <svg
              className="Arrow-down Icon-fontSizeLarge"
              viewBox="0 0 24 24"
            >
